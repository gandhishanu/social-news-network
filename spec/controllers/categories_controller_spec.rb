...
RSpec.describe CategoriesController, type: :controller do
  ...
  let(:valid_attributes) {
    ...
    {name: 'Entertainment', description: 'This is the description', thumbnail: 'thumbnail.jpg'}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: 'Entertainment2', description: 'This is the description2', thumbnail: 'thumbnail2.jpg'}
      }
